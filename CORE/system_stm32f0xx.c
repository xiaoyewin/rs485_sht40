...
//    }
  ...
  { /* If HSE fails to start-up, the application will have wrong clock 
    ...
    /* HCLK = SYSCLK */
    RCC->CFGR |= (uint32_t)RCC_CFGR_HPRE_DIV1;  //APB clock (PCLK)  不分频  RCC_CFGR_HPRE_DIV8  RCC_CFGR_HPRE_DIV1

    /* PCLK = HCLK */
    RCC->CFGR |= (uint32_t)RCC_CFGR_PPRE_DIV1;   //RCC_CFGR_PPRE_DIV1  

    // PLL configuration = (HSI/2) * 12 = 48 MHz  HSI/2 selected as PLL input clock 
